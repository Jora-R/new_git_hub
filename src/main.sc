...
theme: /
    ...
    # state: Тест
    #     q!: тест
    #     a: Перевод на добавочный 7007.
    #     script: 
    #             $session.operatorPhoneNumber =  '7007';
    ...
    # state: Налоговое резиденство
    #     intent!: /025 Налоги/Налоговое резидентство
    #         a: Заглушка. Текст про налоговое резиденство.
    #         a: Чем я могу еще помочь?
    #         q: @repeat_please * ||toState = "."
    #         q: @disagree ||toState = "/Могу еще чем то помочь?/NO"    
    ...
    state: Санкции_СПБ_биржа
        ...
        a: СПБ биржа с 28 ноября перевела иностранные ценные бумаги на неторговый раздел счета. После перевода на неторговый раздел, бумаги исключены из торговых лимитов биржи, поэтому не отображаются в терминале, но их наличие отражено в личном кабинете брокера во вкладке Портфель, а также в справке по счету.
    ...
    state: Демо счет_информация по ИТС
        ...
        script:
            $session.ITS = $parseTree._ITS_demo;
    ...
    state: Оператор
        ...
        state: Регион добавочные_уточнение улицы
            ...
            state: Уфа
                ...
                q: * @officePhone_ufa * ||toState = "/Оператор/Регион добавочные"
                q: * @repeat_please * ||toState = "."
                q: @disagree ||toState = "/Другой_вопрос"
            ...
            state: Казань
                ...
                q: * @officePhone_kazan * ||toState = "/Оператор/Регион добавочные"
                q: * @repeat_please * ||toState = "."
                q: @disagree ||toState = "/Другой_вопрос"    
