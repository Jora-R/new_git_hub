...
theme: /
    ...
    state: IVR меню бота
        ...
        state: ПРЕМИУМ
            if: (($client.profileCRM.Result.FirstName != null) && ($client.profileCRM.Result.MiddleName != null))
                a: {{$client.profileCRM.Result.FirstName}} {{$client.profileCRM.Result.MiddleName}}
