...
theme: /
    ...
    state: Яндекс
        ...
        a: Брокер Фина'м автоматически проведет биржевой обмен акций Yandex эН Вэ для своих клиентов. Дополнительных действий от инвесторов не требуется. В связи с автоматическим обменом ценных бумаг, ранее поданные поручения будут отменены.
        # script:
        #     if (identificationAO($client.profileCRM) == "success"){
        #         $context.session.lastState = $context.currentState;
