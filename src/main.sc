...
theme: /
    ...
    state: Корпоративные действия_Яндекс_ЖП
        q!: * @yandex_HC *
        go!: /Корпоративные действия_Яндекс    
        
    state: Корпоративные действия_Элемент_ЖП
        q!: * @element_HC *
        go!: /Корпоративные действия_Элемент
    ...
    state: Выплата дохода_Календарь_ЖП
        q!: * @divcalendar_HC *
        go!: /Выплата дохода_Календарь
    ...
    state: ИИС_Еще_Расторжение ИИС
        a: Расторжение индивидуальных инвестиционных счетов происходит автоматически после исполнения вывода/перевода активов (денежных средств и ценных бумаг). Счет считается расторгнутым на пятый рабочий день.
    ...
    state: ИИС_Еще_Расторжение ИИС_Расторжение перевод
        a: Перевод активов в рамках ИИС с сохранением срока действия:
            1. Откройте ИИС у другого брокера и скачайте уведомление об открытии счета. 
            2. Направьте менеджеру поддержки «Финам» реквизиты нового ИИС и уведомление об открытии счета, открытого у другого брокера. Менеджер сформирует поручение на вывод ценных бумаг в «Финаме». 
            3. Подайте у другого брокера встречные поручения на ввод ценных бумаг. 
            ...
            4. Перевод денежных средств и ценных бумаг между счетами ИИС осуществляется только напрямую между брокерами. После вывода активов, ИИС в «Финам» автоматически закроется на 5-й рабочий день.
             [Сформировать поручение на вывод денежных средств на новый ИИС можно в личном кабинете|https://edox.finam.ru/orders/MoneyOut/MoneyOut/Default.aspx]: выбрать вывод на счета третьих лиц, обязательно вложить документы об открытии нового ИИС у другого брокера. (Доступно для клиентов, прошедших идентификацию в офисе компании.)
            5. После закрытия договора ИИС возьмите справку «Сведения о ФЛ и его ИИС» и предоставьте новому брокеру не позднее 30 дней с даты ввода первого актива на новый ИИС. 
        buttons:
            "Перевод на оператора" -> /Перевод на оператора
            
    state: ИИС_Третьего типа || sessionResultColor = "#CD4C2B"
        a: Отличия нового вида ИИС от старого типа:
            ✅ Инвестор может открывать и владеть тремя ИИС нового типа одновременно. 
            Счет ИИС, открытый до 31 декабря 2023 года по-прежнему можно иметь только один. Если у инвестора уже есть счет ИИС старого образца, открытый до 31 декабря 2023 года, то при желании дополнительно открыть ИИС нового образца, нужно [трансформировать старый тип ИИС в новый|https://edox.finam.ru/orders/IisContractTransform].
            ✅ Договоры ИИС, открытые в период с 2024 по 2026 год, нельзя закрыть раньше, чем через 5 лет. Каждый последующий год минимальный срок владения ИИС будет увеличиваться и к 2031 году составит 10 лет.
            ✅ Для счетов, открытых до 31 декабря 2023 года, доступно пополнение до 1000000 ₽ в год. У ИИС нового типа ограничений на пополнение нет.
            ✅ К ИИС, открытым до 31 декабря 2023 года, можно применить один налоговый вычет на выбор. По ИИС третьего типа можно получать обе льготы сразу, при этом по льготе в размере финансового результата (тип Б) максимальный лимит составит 30000000 ₽.
            ✅ На законодательном уровне рассматривается возможность выводить денежные средства с ИИС до конца срока, для оплаты дорогостоящего лечения. 
    ...
    state: Выплата дохода || sessionResultColor = "#15952F"
        ...
        buttons:
            ...
            "Календарь дивидендов" -> /Выплата дохода_Календарь
    ...
    state: Выплата дохода_Календарь || sessionResultColor = "#B65A1E"
        a: «Календарь дивидендов» можно посмотреть в [веб-терминале FinamTrade|https://trading.finam.ru/]
            ✅ В левом вертикальном меню выберите значок с календарем
            ✅ Настройте календарь под себя по фильтрам:
            — Утвержденным/Прошедшим выплатам дивидендов 
            — Всем акциям/Российским/Иностранным/Акциям в портфеле
            ✅ Также в [терминале FinamTrade|https://trading.finam.ru/] можно посмотреть информацию об утвержденных дивидендах и истории выплат по конкретной ценной бумаге:
            — Выберите бумагу из поиска или портфеля
            — Справа в информации по ценной бумаге выберите раздел «Дивиденды»
    ...
    state: Срочный рынок_Обеспечение
        ...
        buttons:
            "Отключение фондовой и валютной секций по счетам ЕДП" -> /Отключение секций
    ...
    state: Срочный рынок_Ещё_Исполнение
        script:
            $analytics.setMessageLabel("Исполнение ПФИ", "Тех метки");
    ...
    state: Личный кабинет_Торговый код_Кодовое слово || sessionResultColor = "#CD4C2B"
        a: Для дополнительной защиты ваших персональных данных, в компании «Финам» вводится обязательный способ идентификации клиентов - кодовое слово. С 1 сентября 2024 года клиенты компании смогут получить персональную информацию или подать голосовую заявку только после того, как назовут сотруднику своё кодовое слово.
            ✅ Создать, изменить или удалить кодовое слово можно в личном кабинете в [разделе «Учетные данные»|https://lk.finam.ru/user/credentials] 
    ...
    state: Доступные биржи || sessionResultColor = "#418614"
        ...
        if: holidays()
            a: ✅ 27 мая — Memorial Day в США. Торги и расчеты на биржах NYSE/NASDAQ не проводятся, а также не проводятся торги и расчеты с валютой доллар США на Московской бирже.
    ...
    state: Доступные биржи_СПБ
        a: На СПБ Бирже приостановлены торги иностранными ценными бумагами. Доступно закрытие позиций по бумагам эмитентов РФ. Актуальная информация размещается на [официальном сайте биржи|https://spbexchange.ru/ru/about/news2.aspx].
            ✅ В рамках Указа №665, депозитарии используют рубли РФ для выплат по заблокированным активам.
    ...
    state: Режим расчетов || sessionResultColor = "#418614"
        ...
        if: holidays()
            a: ✅ 27 мая — Memorial Day в США. Торги и расчеты на биржах NYSE/NASDAQ не проводятся, а также не проводятся торги и расчеты с валютой доллар США на Московской бирже.
        a: Торги на биржах осуществляются в режимах T+0, Т+1 и Т+2. Это значит, что регистрация прав на ценные бумаги/валюту происходит не в момент заключения сделки, а позднее.
            ✅ Т+0 – расчеты в день сделки
            ✅ Т+1 (Y1) – расчеты на следующий рабочий день
            ✅ Т+2 (Y2) – расчеты на второй рабочий день
            1. Торги облигациями осуществляются в режиме Т+1. Накопленный купонный доход считается на дату расчетов по сделке и перечисляется продавцу в тот же день.
            ...
            3. Торги на СПБ Бирже российскими и квазироссийскими акциями проводятся в режиме Т+1.
            4. Торги международными ценными бумагами на иностранных биржах проходят в режиме Т+2.
            ❗ С 28 мая 2024 года американские биржи переходят на режим торгов «Т+1». [Подробнее|https://www.finam.ru/publications/item/ssha-perekhodyat-na-t1-20240519-1800]
    ...
    state: Корпоративные действия_Замещение || sessionResultColor = "#B65A1E"
        ...
        a: ✅ Замещенные облигации VTB будут зачислены на брокерские счета инвесторов до 31 мая.
    ...
    state: Корпоративные действия_Яндекс || sessionResultColor = "#B65A1E"
        a: МКПАО ЯНДЕКС — будущая головная компания Яндекса, к которой перейдёт большинство сервисов и активов Yandeх N.V. Акционерам Yandex N.V. предлагается обменять свои акции на акции МКПАО ЯНДЕКС с коэффициентом 1:1 через инфраструктуру Московской и СПБ бирж. Участвовать в обмене могут инвесторы, которые приобрели акции Яндекса на Московской или СПБ бирже. Подача заявок до 15:00 МСК 19 июня 2024 года.
            ❗ Брокер «Финам» автоматически подаст заявку на обмен акций Yandeх N.V. для своих клиентов. В настоящее время ведутся работы над функционалом автоматической подачи.
            ✅ Посмотреть, на какой бирже хранится ценная бумага в портфеле, можно:
            — в [личном кабинете|https://edox.finam.ru/], для этого нужно выбрать счёт, на котором хранится ценная бумага, в разделе «Портфель online» в таблице с перечнем активов на счёте отображается биржа в столбце «Площадка»
            — в терминале FinamTrade нужно нажать правой кнопкой мыши по активу в портфеле, выбрать «Детали позиции», под названием актива отображается биржа
            ✅ Актуальная информация об участии в выкупе на [сайте эмитента|https://yatenderoffer.ru/%D0%BE%D0%B1%D1%89%D0%B8%D0%B5-%D0%B2%D0%BE%D0%BF%D1%80%D0%BE%D1%81%D1%8B/]
            
    state: Корпоративные действия_Элемент || sessionResultColor = "#B65A1E"
        a: В период с 24 мая до 10:05 МСК 29 мая клиентам «Финам» открыта возможность участвовать в IPO «Элемент». Планируемая дата размещения ценной бумаги — 30 мая 2024.
            ✅ Подача заявки доступна в [личном кабинете|https://lk.finam.ru/ipo]
            ✅ 27 мая в 17:00 МСК приглашаем инвесторов на онлайн-встречу, посвященную размещению на СПБ Бирже ПАО «Элемент».  [Узнать подробнее и зарегистрироваться|https://www.finam.ru/landing/event-meeting-element/]
    ...
    state: Ошибки заявок || sessionResultColor = "#15952F"
        ...
        a: ✅ Популярные типы ошибок при выставлении заявок:
            ...
            ✅ Другие ошибки при выставлении заявок и способы их решения:
        buttons:
            ...
            "Для данного инструмента невозможно выставление рыночных заявок" -> /Ошибки заявок_для данного инструмента невозможно выставление рыночных заявок
    ...
    state: Ошибки заявок_Нет кнопки || sessionResultColor = "#CD4C2B"
        a: По недоступным для торговли инструментам кнопка «Заявка» заблокирована, в терминале FinamTrade такие инструменты отмечены символом «Замок».
            ...
            ❗ Обращаем Ваше внимание, активация счета происходит после пополнения от 150 рублей. 
    ...
    state: Ошибки заявок_Сделки по данному
        a: Данная ошибка может возникать в том случае, если заявка выставляется со счета нерезидента РФ.
                ❗ Торговля резидентам недружественных стран недоступна.
    ...
    state: Ошибки заявок_для данного инструмента невозможно выставление рыночных заявок
        a: Уведомление с текстом «Для данного инструмента невозможно выставление рыночных заявок» может возникать в следующих ситуациях:
            ✅ Во время премаркета и постмаркета на рынке NYSE/NASDAQ недоступно выставление «рыночных» заявок.
            ✅ По ряду инструментов ограничено выставление рыночных заявок биржей либо брокером, временно либо на постоянной основе. Например, такое ограничение возможно для низколиквидных или высоковолатильных инструментов. 
            ✅ Подробнее об особенностях выставления заявок на разных рынках:
        buttons:
            "Выставление заявок" -> /Заявки_Выставление
    ...
    state: Ошибки заявок_Другие
        ...
        buttons:
            ...
            "Запрет трейдера на открытие позиций" -> /Ошибки заявок_Другие_Запрет трейдера
            "Не найден доступный маршрут" -> /Ошибки заявок_Другие_Не найден доступный маршрут
    ...
    state: Ошибки заявок_Другие_Запрет трейдера || sessionResultColor = "#CD4C2B"
    ...
    state: Ошибки заявок_Другие_Не найден доступный маршрут
        a: Уведомление с текстом «Не найден доступный маршрут» возникает в случае, если нарушены условия выставления заявки. 
            ✅ Например, на бирже Гонконга нужно соблюдать минимальный объем заявок от 8000 HKD.
            ✅ Подробнее об особенностях выставления заявок на разных рынках:
        buttons:
            "Выставление заявок" -> /Заявки_Выставление
    
    state: Ошибки заявок_Другие_Маркетные
        a: Для исключения ошибок при срабатывании отложенных ордеров на рынке NYSE/NASDAQ запрещено выставление условных заявок, тейк-профита и стоп-лосса, с «рыночным» исполнением. Цену исполнения и защитный спред необходимо указать самостоятельно (как при выставлении лимитной заявки).
            ✅ Подробнее об особенностях выставления заявок на разных рынках:
        buttons:
            "Выставление заявок" -> /Заявки_Выставление
    ...
    state: Балансовая средняя || sessionResultColor = "#15952F"
        ...
        a: Балансовая стоимость рассчитывается как среднее арифметическое всех открытых позиций.
            ...
            ✅ В торговых терминалах, в зависимости от типа счёта, разная логика отображения расчётной цены фьючерса (средней цены приобретения):
                – для счетов ЕДП используется фактическая средняя цена открытия позиции
                – для моно-счетов используется цена последнего клиринга
    ...
    state: Инструменты || sessionResultColor = "#15952F"
    ...
    state: Отключение секций
        intent!: /094 Отключение секций
        a: Чтобы отключить или подключить фондовую и валютную секции по счету «Единая денежная позиция», обратитесь к менеджеру поддержки:
            ❗ Предварительно необходимо заполнить в личном кабинете [раздел «Инвестиционный профиль»|https://lk.finam.ru/user/invest-profile]
