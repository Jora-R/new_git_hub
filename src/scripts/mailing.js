...
function mailling(){
    ...
    // ID_button = ""; // поле используется для теста нажатой кнопки рассылки
    // $reactions.answer("mailling()");
    if(want_chat[ID_button] != undefined) {
        $analytics.setMessageLabel("want_chat", "Рассылки");
        ...
        $analytics.setMessageLabel("want_call", "Рассылки");
        ...
        $analytics.setMessageLabel("want_link", "Рассылки");
        $reactions.answer("Спасибо за проявленный интерес! Если у вас возникнут вопросы, нажмите выше «Продолжить в чате» или «Заказать звонок».");
